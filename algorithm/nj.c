...
function [t,u]=orbit(ms,T,u0)
f=@(t,u) [u(5:8);
-ms(1)*u(1:2)/norm(u(1:2))^3 ...
+ms(3)*(u(3:4)-u(1:2))/norm(u(3:4)-u(1:2))^3;
-ms(1)*u(3:4)/norm(u(3:4))^3 ...
+ms(2)*(u(1:2)-u(3:4))/norm(u(1:2)-u(3:4))^3];
[t,u]=rkck(f,[0,T],u0,1e-6,1e-6,1);
